...
namespace AhiaPay.ViewModels.Onboardings;
public partial class WalkthroughImageViewModel : ObservableObject
{
    private INavigation _navigationService;
    private Page _pageService;
    
    public WalkthroughImageViewModel(INavigation navigationService, Page pageService)
    {
